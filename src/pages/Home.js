...
const Home = () => {
  ...
  useEffect(() => {
    const interval = setInterval(changer, 5000);
    ...
    <>
      ...
      <div className="relative z-[1]">
        <div className="relative">
          <div className="py-24 z-50 absolute top-0 left-0 right-0 bottom-0 flex flex-col items-center text-white text-center">
            <h1 className="text-[44px] md:text-[64px] font-bold my-4 animate__animated animate__zoomIn mt-[5rem]">
              Quality Renovation at its best
            </h1>
            <p className="text-[20px] md:text-[26px] mb-3">
              Best Home Remodeling company in Botswana
            </p>
            <div className="flex gap-5 relative z-[60] ">
              <NavLink to="/message">
        ...
        <div className="absolute top-50 bottom-0 left-0 right-0 z-5  ">
      ...
      <div className="bg-white shadow md:mx-5 rounded-md py-8 my-5">
        ...
        <p
          ...
          style={{ fontSize: "16px" }}
        >
          If you need any help with your home remodeling, give us a call at M&B
          Remodeling. We offer variety of home renovation services in M&B
          enterprises
        </p>
