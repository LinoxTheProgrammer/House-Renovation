...
const Result = () => {
    return (
        <section className="bg-gray-100 ">
            ...
            <h2 className="text-blue-500 font-bold text-4xl text-center mt-4">House Remodeling Service</h2>
            <p className="text-gray-500 max-w-lg mx-auto text-center py-2" style={{ fontSize: '14px' }}>
                If you need any help with home remodeling, give us a call at M&B Remodeling. We offer variety of
                home renovation services in M&B enterprises
            </p>
